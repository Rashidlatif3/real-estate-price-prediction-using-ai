...
passport.use(new GoogleStrategy({
    clientID: '24316092694-t7nk4meet262ugjtqk4l4bvbaq66ehsu.apps.googleusercontent.com',
    clientSecret: '24316092694-t7nk4meet262ugjtqk4l4bvbaq66ehsu.apps.googleusercontent.com',
...
app.get('/register', (req, res) => {
    res.render('register', { errors: [], data: {}, title: 'Register' });
});
...
app.get('/login', (req, res) => {
    res.render('login', { errors: [], data: {}, title: 'Login' });
});
...
app.get('/', async (req, res) => {
    ...
    try {
        ...
        res.render('index', { properties, filters: req.query, title: 'Home' });
    } catch (err) {
        res.status(500).send('Server Error');
    }
});
...
app.get('/properties/new', (req, res) => {
    res.render('new', { title: 'Add Property' });
});
...
app.get('/properties/:id/edit', async (req, res) => {
    try {
        ...
        res.render('edit', { property, title: 'Edit Property' });
    } catch (err) {
        res.status(500).send('Server Error');
    }
});
...
app.get('/dashboard', async (req, res) => {
    try {
        ...
        res.render('dashboard', { properties, user: req.user, title: 'Dashboard' });
    } catch (err) {
        res.status(500).send('Server Error');
    }
});
...
app.get('/advertisements', async (req, res) => {
    try {
        ...
        res.render('advertisements', { ads, title: 'Advertisements' });
    } catch (err) {
        res.status(500).send('Server Error');
    }
});
...
app.get('/advertisements/new', (req, res) => {
    res.render('add_advertisement', { title: 'Add Advertisement' });
});
